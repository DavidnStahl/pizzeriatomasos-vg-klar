...
namespace TomasosPizzeriaUppgift.Migrations
{
    ...
    [Migration("20200128195456_CreateIdentitySchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.Bestallning", b =>
                {
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.BestallningMatratt", b =>
                {
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.Kund", b =>
                {
                    b.Property<int>("KundId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("KundID")
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.Matratt", b =>
                {
                    b.Property<int>("MatrattId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("MatrattID")
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.MatrattProdukt", b =>
                {
                    b.Property<int>("MatrattId")
                        .HasColumnName("MatrattID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.MatrattTyp", b =>
                {
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.Produkt", b =>
                {
                    b.Property<int>("ProduktId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProduktID")
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.Bestallning", b =>
                {
                    b.HasOne("TomasosPizzeriaUppgift.Models.Kund", "Kund")
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.BestallningMatratt", b =>
                {
                    b.HasOne("TomasosPizzeriaUppgift.Models.Bestallning", "Bestallning")
                        .WithMany("BestallningMatratt")
                        .HasForeignKey("BestallningId")
                        .HasConstraintName("FK_BestallningMatratt_Bestallning")
                        .IsRequired();

                    b.HasOne("TomasosPizzeriaUppgift.Models.Matratt", "Matratt")
                        .WithMany("BestallningMatratt")
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.Matratt", b =>
                {
                    b.HasOne("TomasosPizzeriaUppgift.Models.MatrattTyp", "MatrattTypNavigation")
                        .WithMany("Matratt")
            ...
            modelBuilder.Entity("TomasosPizzeriaUppgift.Models.MatrattProdukt", b =>
                {
                    ...
                    b.HasOne("TomasosPizzeriaUppgift.Models.Produkt", "Produkt")
                        .WithMany("MatrattProdukt")
